...
```{r warning=FALSE, cache=TRUE}
p1=ggplot(data= model, aes(x=model$fitted.values, y=model$residuals))+geom_point(shape=1, size=3)+xlab('Fitted BirthWt')+ylab('Residuals')+theme(axis.title=element_text(size=12))+geom_hline(yintercept = 1)+ggtitle('Constant Variance Assumption')

p2 =ggplot(data= data_table,aes(x=data_table$Age,y=model$residuals))+geom_point(shape=1,size=3)+xlab('Age')+ylab('Residuals')+theme(axis.title = element_text(size=12))+geom_hline(yintercept=1)+ggtitle('Linearity Assumption')

p3 =ggplot(data= data_table,aes(x=data_table$MotherWt,y=model$residuals))+geom_point(shape=1,size=3)+xlab('MotherWt')+ylab('Residuals')+theme(axis.title=element_text(size=12))+geom_hline(yintercept=1)+ggtitle('Linearity Assumption')

p4 =ggplot(data= data_table,aes(x=data_table$NumPreLabor,y=model$residuals))+geom_point(shape=1,size=3)+xlab('NumPreLabor')+ylab('Residuals')+theme(axis.title = element_text(size=12))+geom_hline(yintercept = 1)+ggtitle('Linearity Assumption')

p5 =ggplot(data= data_table,aes(x=data_table$NumPhysicianVt,y=model$residuals))+geom_point(shape=1,size=3)+xlab('NumPhysicianVt')+ylab('Residuals')+theme(axis.title =element_text(size=12))+geom_hline(yintercept = 1)+ggtitle('Linearity Assumption')
